	...
	$.getJSON("json/stats.json", function(result) {
		...
		for (var i = 0; i < result.servers.length; i++) {
			...
			if (result.servers[i].online4) {
				...
				TableRow.children["online4"].children[0].children[0].innerHTML = "<small>ON</small>";
			} else {
				TableRow.children["online4"].children[0].children[0].className = "progress-bar progress-bar-danger";
				TableRow.children["online4"].children[0].children[0].innerHTML = "<small>OFF</small>";
			}
			...
			if (result.servers[i].ip_status) {
				...
				TableRow.children["ip_status"].children[0].children[0].innerHTML = "<small>ON</small>";
			} else {
				TableRow.children["ip_status"].children[0].children[0].className = "progress-bar progress-bar-danger";
				TableRow.children["ip_status"].children[0].children[0].innerHTML = "<small>OFF</small>";
			}
